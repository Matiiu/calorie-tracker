...
export default function Form() {
  ...
  const nameSubmit = () => {
    // Convertimos las catorias en un objeto donde el id en la llave y el nobre el valor
  ...
  return (
    <form className="space-y-5 bg-white shadow p-10 rounded-lg">
      ...
      <input
        type="submit"
        className="bg-gray-800 hover:bg-gray-900 w-full p-2 font-bold text-white cursor-pointer disabled:opacity-8 disabled:cursor-auto"
